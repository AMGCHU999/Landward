...
for (const [label, evaluate] of [
  ...
  test(`${label}: clean applicant: low tier, no review, no criminal question asked`, async () => {
  ...
  test(`${label}: composite score weights financial risk at 0.6 and tenancy history at 0.4`, async () => {
